...
public class SpClickPostNailExtensionNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_nail_extension_nakuru);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostNailExtensionNakuru.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostNailExtensionNakuru.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostNailExtensionNakuru.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostNailExtensionNakuru.this, SpHomeLocation.class);
