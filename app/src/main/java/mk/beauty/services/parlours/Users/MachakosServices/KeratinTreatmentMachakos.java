package mk.beauty.services.parlours.Users.MachakosServices;
...
import mk.beauty.services.parlours.Users.KisumuServices.ClickPost.ClickPostBraidingKisumu;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.MachakosServices.ClickPost.ClickPostKeratinTreatmentMachakos;
import mk.beauty.services.parlours.Users.Posts;

public class KeratinTreatmentMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keratin_treatment_machakos);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Machakos").child("KeratinTreatment");
        ...
        postserviceslist = findViewById(R.id.recycler_keratin_treatment_machakos);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(KeratinTreatmentMachakos.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(KeratinTreatmentMachakos.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, KeratinTreatmentMachakos.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, KeratinTreatmentMachakos.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull KeratinTreatmentMachakos.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(KeratinTreatmentMachakos.this, ClickPostKeratinTreatmentMachakos.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(KeratinTreatmentMachakos.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public KeratinTreatmentMachakos.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new KeratinTreatmentMachakos.PostsViewholder(view);
            }
