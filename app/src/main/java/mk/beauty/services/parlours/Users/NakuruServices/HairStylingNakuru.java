...
import mk.beauty.services.parlours.Users.NakuruServices.ClickPost.ClickPostHairStylingNakuru;
import mk.beauty.services.parlours.Users.Posts;

public class HairStylingNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hair_styling_nakuru);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nakuru").child("HairStyling");
        ...
        postserviceslist = findViewById(R.id.recycler_hair_styling_nakuru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(HairStylingNakuru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(HairStylingNakuru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, HairStylingNakuru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, HairStylingNakuru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull HairStylingNakuru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(HairStylingNakuru.this, ClickPostHairStylingNakuru.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(HairStylingNakuru.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public HairStylingNakuru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new HairStylingNakuru.PostsViewholder(view);
            }
