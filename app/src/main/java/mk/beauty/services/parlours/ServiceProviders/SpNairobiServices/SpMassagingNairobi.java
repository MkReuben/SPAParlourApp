...
import mk.beauty.services.parlours.ServiceProviders.SpNairobiServices.ClickPost.SpClickPostMassagingNairobi;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.Posts;

public class SpMassagingNairobi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_massaging_nairobi);
        ...
        postserviceslist = findViewById(R.id.recycler_sp_massaging_nairobi);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpMassagingNairobi.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpMassagingNairobi.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpMassagingNairobi.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpMassagingNairobi.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                    {
//
//                        Intent clickPostIntent=new Intent(SpMassagingNairobi.this, SpClickPostMassagingNairobi.class);
...
//                });
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpMassagingNairobi.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpMassagingNairobi.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.sp_all_post_layout,parent,false);

                return new SpMassagingNairobi.PostsViewholder(view);
            }
