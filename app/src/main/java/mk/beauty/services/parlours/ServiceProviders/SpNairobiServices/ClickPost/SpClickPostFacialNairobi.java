...
public class SpClickPostFacialNairobi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_facial_nairobi);
        mAuth=FirebaseAuth.getInstance();
        currentUserID=mAuth.getCurrentUser().getUid();

        PostKey =getIntent().getExtras().get("PostKey").toString();
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("Services").child("Nairobi").child("Facial").child(PostKey);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostFacialNairobi.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostFacialNairobi.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostFacialNairobi.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostFacialNairobi.this, SpHomeLocation.class);
