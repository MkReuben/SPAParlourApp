...
import mk.beauty.services.parlours.Users.MeruServices.ClickPost.ClickPostPreBridalMeru;
import mk.beauty.services.parlours.Users.Posts;

public class PreBridalPackageMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_bridal_package_meru);
        ...
        postserviceslist = findViewById(R.id.recycler_pre_bridal_package_meru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(PreBridalPackageMeru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(PreBridalPackageMeru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts,PreBridalPackageMeru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, PreBridalPackageMeru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull PreBridalPackageMeru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(PreBridalPackageMeru.this, ClickPostPreBridalMeru.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(PreBridalPackageMeru.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public PreBridalPackageMeru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new PreBridalPackageMeru.PostsViewholder(view);
            }
