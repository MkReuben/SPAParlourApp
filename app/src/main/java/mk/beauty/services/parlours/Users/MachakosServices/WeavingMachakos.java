...
import mk.beauty.services.parlours.Users.MachakosServices.ClickPost.ClickPostWeavingMachakos;
import mk.beauty.services.parlours.Users.MombasaServices.ClickPost.ClickPostWeavingMombasa;
import mk.beauty.services.parlours.Users.NakuruServices.WeavingNakuru;
import mk.beauty.services.parlours.Users.Posts;

public class WeavingMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weaving_machakos);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Machakos").child("Weaving");
        ...
        postserviceslist = findViewById(R.id.recycler_weaving_machakos);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(WeavingMachakos.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(WeavingMachakos.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, WeavingMachakos.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, WeavingMachakos.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull WeavingMachakos.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(WeavingMachakos.this, ClickPostWeavingMachakos.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(WeavingMachakos.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public WeavingMachakos.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new WeavingMachakos.PostsViewholder(view);
            }
