...
public class SpClickPostBraidingMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_braiding_machakos);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostBraidingMachakos.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostBraidingMachakos.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostBraidingMachakos.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostBraidingMachakos.this, SpHomeLocation.class);
