...
import mk.beauty.services.parlours.Users.NairobiServices.ClickPost.ClickPostGelNails;
import mk.beauty.services.parlours.Users.Posts;

public class GelNails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gel_nails);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nairobi").child("GelNails");
        ...
        postserviceslist = findViewById(R.id.recycler_gel_nails);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(GelNails.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(GelNails.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, GelNails.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, GelNails.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull GelNails.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(GelNails.this, ClickPostGelNails.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(GelNails.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public GelNails.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new GelNails.PostsViewholder(view);
            }
