...
import mk.beauty.services.parlours.ServiceProviders.SpMeruServices.ClickPost.SpClickPostManicureMeru;
...
public class SpManicureMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_manicure_meru);

        mAuth = FirebaseAuth.getInstance();
        currentUserID = mAuth.getCurrentUser().getUid();
        LikesRef = FirebaseDatabase.getInstance().getReference().child("Likes");
        CommentsRef=FirebaseDatabase.getInstance().getReference().child("Comments");
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Meru").child("Manicure");
        ...
        postserviceslist = findViewById(R.id.recycler_sp_manicure_meru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpManicureMeru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpManicureMeru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, SpManicureMeru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpManicureMeru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpManicureMeru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        Intent clickPostIntent=new Intent(SpManicureMeru.this, SpClickPostManicureMeru.class);
...
//                });
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpManicureMeru.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpManicureMeru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.sp_all_post_layout,parent,false);

                return new SpManicureMeru.PostsViewholder(view);
            }
