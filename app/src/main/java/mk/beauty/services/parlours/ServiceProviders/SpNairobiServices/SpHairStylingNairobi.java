...
import mk.beauty.services.parlours.ServiceProviders.SpNairobiServices.ClickPost.SpClickPostHairStylingNairobi;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.Posts;

public class SpHairStylingNairobi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_hair_styling_nairobi);
        ...
        postserviceslist = findViewById(R.id.recycler_sp_hair_styling_nairobi);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpHairStylingNairobi.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpHairStylingNairobi.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpHairStylingNairobi.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpHairStylingNairobi.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                    {
//
//                        Intent clickPostIntent=new Intent(SpHairStylingNairobi.this, SpClickPostHairstylingNairobi.class);
...
//                });
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpHairStylingNairobi.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpHairStylingNairobi.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.sp_all_post_layout,parent,false);

                return new SpHairStylingNairobi.PostsViewholder(view);
            }
