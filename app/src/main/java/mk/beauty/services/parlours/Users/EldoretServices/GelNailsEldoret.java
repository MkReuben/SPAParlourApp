...
import mk.beauty.services.parlours.Users.EldoretServices.ClickPost.ClickPostGelNailsEldoret;
...
public class GelNailsEldoret extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gel_nails_eldoret);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Eldoret").child("GelNails");
        ...
        postserviceslist = findViewById(R.id.recycler_gel_nails_eldoret);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(GelNailsEldoret.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(GelNailsEldoret.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, GelNailsEldoret.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, GelNailsEldoret.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull GelNailsEldoret.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(GelNailsEldoret.this, ClickPostGelNailsEldoret.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(GelNailsEldoret.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public GelNailsEldoret.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new GelNailsEldoret.PostsViewholder(view);
            }
