package mk.beauty.services.parlours.Users.EldoretServices;
...
import mk.beauty.services.parlours.Users.CommentsActivity;
import mk.beauty.services.parlours.Users.EldoretServices.ClickPost.ClickPostPreBridalPackagesEldoret;
...
import mk.beauty.services.parlours.Users.NakuruServices.ClickPost.ClickPostBraidingNakuru;
import mk.beauty.services.parlours.Users.Posts;

public class PreBridalPackagesEldoret extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_bridal_packages_eldoret);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Eldoret").child("PreBridalPackages");
        ...
        postserviceslist = findViewById(R.id.recycler_pre_bridal_packages_eldoret);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(PreBridalPackagesEldoret.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(PreBridalPackagesEldoret.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, PreBridalPackagesEldoret.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, PreBridalPackagesEldoret.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull PreBridalPackagesEldoret.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(PreBridalPackagesEldoret.this, ClickPostPreBridalPackagesEldoret.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(PreBridalPackagesEldoret.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public PreBridalPackagesEldoret.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new PreBridalPackagesEldoret.PostsViewholder(view);
            }
            ...
            CommentsRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    if (dataSnapshot.child(PostKey).hasChild(currentUserId))
                    {
                        ...
                        numberOfReviews.setText((Integer.toString(countReviews)+(" Reviews")));
                    }
                    else
                    {
                        countReviews=(int)dataSnapshot.child(PostKey).getChildrenCount();
