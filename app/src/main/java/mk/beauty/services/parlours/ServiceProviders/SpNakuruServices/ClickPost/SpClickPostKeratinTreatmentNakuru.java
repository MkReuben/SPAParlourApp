...
public class SpClickPostKeratinTreatmentNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_keratin_treatment_nakuru);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostKeratinTreatmentNakuru.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostKeratinTreatmentNakuru.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostKeratinTreatmentNakuru.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostKeratinTreatmentNakuru.this, SpHomeLocation.class);
