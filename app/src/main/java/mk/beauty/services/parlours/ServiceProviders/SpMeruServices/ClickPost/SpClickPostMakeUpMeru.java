...
public class SpClickPostMakeUpMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_make_up_meru);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostMakeUpMeru.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostMakeUpMeru.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostMakeUpMeru.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostMakeUpMeru.this, SpHomeLocation.class);
