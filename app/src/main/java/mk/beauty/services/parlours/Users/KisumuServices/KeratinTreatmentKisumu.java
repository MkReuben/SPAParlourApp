...
import mk.beauty.services.parlours.Users.KisumuServices.ClickPost.ClickPostKeratinTreatmentKisumu;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.Posts;

public class KeratinTreatmentKisumu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keratin_treatment_kisumu);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Kisumu").child("KeratinTreatment");
        ...
        postserviceslist = findViewById(R.id.recycler_keratin_treatment_kisumu);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(KeratinTreatmentKisumu.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(KeratinTreatmentKisumu.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, KeratinTreatmentKisumu.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, KeratinTreatmentKisumu.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull KeratinTreatmentKisumu.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(KeratinTreatmentKisumu.this, ClickPostKeratinTreatmentKisumu.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(KeratinTreatmentKisumu.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public KeratinTreatmentKisumu.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new KeratinTreatmentKisumu.PostsViewholder(view);
            }
