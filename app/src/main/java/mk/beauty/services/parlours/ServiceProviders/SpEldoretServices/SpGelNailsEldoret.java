...
import mk.beauty.services.parlours.ServiceProviders.SpEldoretServices.ClickPost.SpClickPostGelNailsEldoret;
...
public class SpGelNailsEldoret extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_gel_nails_eldoret);
        ...
        postserviceslist = findViewById(R.id.recycler_sp_gelnails_eldoret);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpGelNailsEldoret.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpGelNailsEldoret.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, SpGelNailsEldoret.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpGelNailsEldoret.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpGelNailsEldoret.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        Intent clickPostIntent=new Intent(SpGelNailsEldoret.this, SpClickPostGelNailsEldoret.class);
...
//                });
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpGelNailsEldoret.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpGelNailsEldoret.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater = LayoutInflater.from(parent.getContext());
                View view = inflater.inflate(R.layout.sp_all_post_layout, parent, false);

                return new SpGelNailsEldoret.PostsViewholder(view);
            }
