...
import mk.beauty.services.parlours.ServiceProviders.SpNairobiServices.ClickPost.SpClickPostFacialNairobi;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.Posts;

public class SpFacialNairobi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_facial_nairobi);
        mAuth = FirebaseAuth.getInstance();
        currentUserID = mAuth.getCurrentUser().getUid();
        LikesRef = FirebaseDatabase.getInstance().getReference().child("Likes");
        CommentsRef=FirebaseDatabase.getInstance().getReference().child("Comments");
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nairobi").child("Facial");
        ...
        postserviceslist = findViewById(R.id.recycler_sp_facial_nairobi);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpFacialNairobi.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpFacialNairobi.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpFacialNairobi.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpFacialNairobi.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                    {
//
//                        Intent clickPostIntent=new Intent(SpFacialNairobi.this, SpClickPostFacialNairobi.class);
...
//                });
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpFacialNairobi.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpFacialNairobi.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.sp_all_post_layout,parent,false);

                return new SpFacialNairobi.PostsViewholder(view);
            }
