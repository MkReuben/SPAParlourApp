...
import mk.beauty.services.parlours.Users.MombasaServices.ClickPost.ClickPostMassagingMombasa;
import mk.beauty.services.parlours.Users.Posts;

public class MassagingMombasa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_massaging_mombasa);

        mAuth = FirebaseAuth.getInstance();
        currentUserID = mAuth.getCurrentUser().getUid();
        LikesRef = FirebaseDatabase.getInstance().getReference().child("Likes");
        CommentsRef=FirebaseDatabase.getInstance().getReference().child("Comments");
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Mombasa").child("Massaging");
        ...
        postserviceslist = findViewById(R.id.recycler_massaging_mombasa);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(MassagingMombasa.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(MassagingMombasa.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts,MassagingMombasa.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, MassagingMombasa.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull MassagingMombasa.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(MassagingMombasa.this, ClickPostMassagingMombasa.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(MassagingMombasa.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public MassagingMombasa.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new MassagingMombasa.PostsViewholder(view);
            }
