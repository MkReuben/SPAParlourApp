...
import mk.beauty.services.parlours.Users.KisumuServices.ClickPost.ClickPostWeavingKisumu;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.Posts;

public class WeavingKisumu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weaving_kisumu);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Kisumu").child("Weaving");
        ...
        postserviceslist = findViewById(R.id.recycler_weaving_kisumu);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(WeavingKisumu.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(WeavingKisumu.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, WeavingKisumu.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, WeavingKisumu.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull WeavingKisumu.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(WeavingKisumu.this, ClickPostWeavingKisumu.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(WeavingKisumu.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public WeavingKisumu.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new WeavingKisumu.PostsViewholder(view);
            }
