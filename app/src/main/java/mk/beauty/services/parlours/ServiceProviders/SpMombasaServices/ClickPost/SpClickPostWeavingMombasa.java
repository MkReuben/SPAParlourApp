...
public class SpClickPostWeavingMombasa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_sp_click_post_weaving_mombasa);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("Services").child("Mombasa").child("Weaving").child(PostKey);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostWeavingMombasa.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostWeavingMombasa.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostWeavingMombasa.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostWeavingMombasa.this, SpHomeLocation.class);
