...
import mk.beauty.services.parlours.ServiceProviders.SpNairobiServices.ClickPost.SpClickPostWeavingNairobi;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.Posts;


public class SpWeavingNairobi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_weaving_nairobi);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nairobi").child("Weaving");
        ...
        postserviceslist = findViewById(R.id.recycler_sp_weaving_nairobi);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpWeavingNairobi.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpWeavingNairobi.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpWeavingNairobi.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpWeavingNairobi.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        Intent clickPostIntent=new Intent(SpWeavingNairobi.this, SpClickPostWeavingNairobi.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpWeavingNairobi.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpWeavingNairobi.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.sp_all_post_layout,parent,false);

                return new SpWeavingNairobi.PostsViewholder(view);
            }
