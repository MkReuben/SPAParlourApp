...
public class SpClickPostHairStylingMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_hair_styling_machakos);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostHairStylingMachakos.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostHairStylingMachakos.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostHairStylingMachakos.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostHairStylingMachakos.this, SpHomeLocation.class);
