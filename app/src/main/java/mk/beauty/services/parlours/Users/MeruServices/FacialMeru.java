...
import mk.beauty.services.parlours.Users.MeruServices.ClickPost.ClickPostFacialMeru;
import mk.beauty.services.parlours.Users.Posts;

public class FacialMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facial_meru);
        ...
        postserviceslist = findViewById(R.id.recycler_facial_meru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(FacialMeru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(FacialMeru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, FacialMeru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, FacialMeru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull FacialMeru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(FacialMeru.this, ClickPostFacialMeru.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(FacialMeru.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public FacialMeru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new FacialMeru.PostsViewholder(view);
            }
