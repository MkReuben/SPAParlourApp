...
public class SpClickPostHairStylingThika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_hair_styling_thika);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostHairStylingThika.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostHairStylingThika.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostHairStylingThika.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SpHome()
    {
        Intent intent=new Intent(SpClickPostHairStylingThika.this, SpHomeLocation.class);
