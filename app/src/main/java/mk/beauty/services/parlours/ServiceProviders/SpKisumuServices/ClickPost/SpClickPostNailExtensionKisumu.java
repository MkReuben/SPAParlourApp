...
public class SpClickPostNailExtensionKisumu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_nail_extension_kisumu);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostNailExtensionKisumu.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostNailExtensionKisumu.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostNailExtensionKisumu.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostNailExtensionKisumu.this, SpHomeLocation.class);
