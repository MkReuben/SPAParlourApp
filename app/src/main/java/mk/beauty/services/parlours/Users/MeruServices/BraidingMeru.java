...
import mk.beauty.services.parlours.Users.MeruServices.ClickPost.ClickPostBraidingMeru;
import mk.beauty.services.parlours.Users.Posts;

public class BraidingMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_braiding_meru);
        ...
        postserviceslist = findViewById(R.id.recycler_braiding_meru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(BraidingMeru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(BraidingMeru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, BraidingMeru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, BraidingMeru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull BraidingMeru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(BraidingMeru.this, ClickPostBraidingMeru.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(BraidingMeru.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public BraidingMeru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new BraidingMeru.PostsViewholder(view);
            }
