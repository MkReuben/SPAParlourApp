...
public class SpClickPostBraidingNairobi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_braiding_nairobi);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("Services").child("Nairobi").child("Braiding").child(PostKey);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostBraidingNairobi.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostBraidingNairobi.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostBraidingNairobi.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostBraidingNairobi.this, SpHomeLocation.class);
