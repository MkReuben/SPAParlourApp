...
import mk.beauty.services.parlours.Users.KisumuServices.ClickPost.ClickPostMakeUpKisumu;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.NairobiServices.ClickPost.ClickPostMakeUp;
import mk.beauty.services.parlours.Users.Posts;

public class MakeUpKisumu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_make_up_kisumu);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Kisumu").child("MakeUp");
        ...
        postserviceslist = findViewById(R.id.recycler_make_up_kisumu);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(MakeUpKisumu.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(MakeUpKisumu.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, MakeUpKisumu.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, MakeUpKisumu.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull MakeUpKisumu.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(MakeUpKisumu.this, ClickPostMakeUpKisumu.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(MakeUpKisumu.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public MakeUpKisumu.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new MakeUpKisumu.PostsViewholder(view);
            }
