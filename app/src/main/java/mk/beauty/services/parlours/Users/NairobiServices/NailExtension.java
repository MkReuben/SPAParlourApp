...
import mk.beauty.services.parlours.Users.NairobiServices.ClickPost.ClickPostNailExtension;
import mk.beauty.services.parlours.Users.Posts;

public class NailExtension extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nail_extension);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nairobi").child("NailExtension");
        ...
        postserviceslist = findViewById(R.id.recycler_nail_extensions);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(NailExtension.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(NailExtension.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, NailExtension.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, NailExtension.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull NailExtension.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(NailExtension.this, ClickPostNailExtension.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(NailExtension.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public NailExtension.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new NailExtension.PostsViewholder(view);
            }
