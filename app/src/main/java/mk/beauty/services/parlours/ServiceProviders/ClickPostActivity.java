...
public class ClickPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("Services").child(PostKey);

        serviceImage=(ImageView)findViewById(R.id.maintain_service_image);
        serviceName=(TextView) findViewById(R.id.maintain_service_name);
        servicePhoneNumber=(TextView)findViewById(R.id.maintain_service_phone_number);
        deleteServiceButton=(Button) findViewById(R.id.maintain_delete);
        editServiceButton=(Button)findViewById(R.id.maintain_post);
    ...
    private void EditCurrentPost(String servicesName, String servicesPhoneNumber)
    {
        ...
        final EditText inputserviceName =new EditText(ClickPostActivity.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(ClickPostActivity.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(ClickPostActivity.this,SpMainActivity.class);
