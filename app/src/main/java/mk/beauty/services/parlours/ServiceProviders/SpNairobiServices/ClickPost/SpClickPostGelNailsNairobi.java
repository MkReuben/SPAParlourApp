...
public class SpClickPostGelNailsNairobi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_gel_nails_nairobi);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostGelNailsNairobi.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostGelNailsNairobi.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostGelNailsNairobi.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostGelNailsNairobi.this, SpHomeLocation.class);
