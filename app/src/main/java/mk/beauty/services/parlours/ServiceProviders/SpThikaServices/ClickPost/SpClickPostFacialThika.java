...
public class SpClickPostFacialThika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_facial_thika);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostFacialThika.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostFacialThika.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostFacialThika.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostFacialThika.this, SpHomeLocation.class);
