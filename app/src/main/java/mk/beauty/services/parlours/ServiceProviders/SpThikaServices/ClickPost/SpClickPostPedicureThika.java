...
public class SpClickPostPedicureThika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_pedicure_thika);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostPedicureThika.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostPedicureThika.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostPedicureThika.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostPedicureThika.this, SpHomeLocation.class);
