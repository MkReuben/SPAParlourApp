...
import mk.beauty.services.parlours.Users.NairobiServices.ClickPost.ClickPostManicure;
import mk.beauty.services.parlours.Users.NairobiServices.Manicure;
import mk.beauty.services.parlours.Users.NakuruServices.ClickPost.ClickPostManicureNakuru;
import mk.beauty.services.parlours.Users.Posts;

public class ManicureNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manicure_nakuru);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nakuru").child("Manicure");
        ...
        postserviceslist = findViewById(R.id.recycler_saloons_nakuru);
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ManicureNakuru.this, LocationActivity.class);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(ManicureNakuru.this, "Refreshed Successfully..", Toast.LENGTH_LONG).show();
    ...
    private void DisplayAllUsersPost() {
        ...
        FirebaseRecyclerAdapter<Posts, ManicureNakuru.PostsViewholder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Posts, ManicureNakuru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ManicureNakuru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.Location.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent clickPostIntent = new Intent(ManicureNakuru.this, ClickPostManicureNakuru.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(ManicureNakuru.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public ManicureNakuru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater = LayoutInflater.from(parent.getContext());
                View view = inflater.inflate(R.layout.all_service_post_layout, parent, false);

                return new ManicureNakuru.PostsViewholder(view);
            }
    ...
    public static class PostsViewholder extends RecyclerView.ViewHolder {
        ...
        TextView numberOfLikes, numberOfReviews;
...
//            Location=itemView.findViewById(R.id.post_service_location);
