...
public class SpClickPostManicureEldoret extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_manicure_eldoret);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostManicureEldoret.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostManicureEldoret.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostManicureEldoret.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostManicureEldoret.this, SpHomeLocation.class);
