...
public class SpClickPostFacialEldoret extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_facial_eldoret);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostFacialEldoret.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostFacialEldoret.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostFacialEldoret.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void DeleteCurrentPost()
    {
        ...
        SendtoSpHomeActivity();

        Toast.makeText(this, "Service has been deleted", Toast.LENGTH_SHORT).show();
    }
    private void SendtoSpHomeActivity()
    {
        Intent intent=new Intent(SpClickPostFacialEldoret.this, SpHomeLocation.class);
