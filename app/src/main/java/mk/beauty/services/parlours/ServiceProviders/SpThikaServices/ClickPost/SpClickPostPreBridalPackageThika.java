package mk.beauty.services.parlours.ServiceProviders.SpThikaServices.ClickPost;
...
public class SpClickPostPreBridalPackageThika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_pre_bridal_package_thika);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostPreBridalPackageThika.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostPreBridalPackageThika.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostPreBridalPackageThika.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostPreBridalPackageThika.this, SpHomeLocation.class);
