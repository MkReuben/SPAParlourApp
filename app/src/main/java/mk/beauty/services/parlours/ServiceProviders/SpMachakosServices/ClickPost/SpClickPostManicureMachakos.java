...
public class SpClickPostManicureMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_manicure_machakos);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostManicureMachakos.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostManicureMachakos.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostManicureMachakos.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostManicureMachakos.this, SpHomeLocation.class);
