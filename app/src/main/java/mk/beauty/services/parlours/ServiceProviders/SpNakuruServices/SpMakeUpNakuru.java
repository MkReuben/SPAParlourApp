...
import mk.beauty.services.parlours.ServiceProviders.SpNakuruServices.ClickPost.SpClickPostMakeUpNakuru;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.Posts;

public class SpMakeUpNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_make_up_nakuru);
        ...
        postserviceslist = findViewById(R.id.recycler_sp_make_up_nakuru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpMakeUpNakuru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpMakeUpNakuru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, SpMakeUpNakuru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpMakeUpNakuru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpMakeUpNakuru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        Intent clickPostIntent=new Intent(SpMakeUpNakuru.this, SpClickPostMakeUpNakuru.class);
...
//                });
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpMakeUpNakuru.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpMakeUpNakuru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.sp_all_post_layout,parent,false);

                return new SpMakeUpNakuru.PostsViewholder(view);
            }
