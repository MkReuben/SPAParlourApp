...
public class SpClickPostFacialMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_facial_machakos);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostFacialMachakos.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostFacialMachakos.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostFacialMachakos.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostFacialMachakos.this, SpHomeLocation.class);
