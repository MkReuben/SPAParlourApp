...
public class BraidingNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_braiding_nakuru);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nakuru").child("Braiding");
        ...
        postserviceslist = findViewById(R.id.recycler_braiding_nakuru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(BraidingNakuru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(BraidingNakuru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, BraidingNakuru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, BraidingNakuru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull BraidingNakuru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(BraidingNakuru.this, ClickPostBraidingNakuru.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(BraidingNakuru.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public BraidingNakuru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new BraidingNakuru.PostsViewholder(view);
            }
