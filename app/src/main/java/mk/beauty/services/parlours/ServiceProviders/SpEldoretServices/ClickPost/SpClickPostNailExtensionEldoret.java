...
public class SpClickPostNailExtensionEldoret extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_nail_extension_eldoret);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostNailExtensionEldoret.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostNailExtensionEldoret.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostNailExtensionEldoret.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostNailExtensionEldoret.this, SpHomeLocation.class);
