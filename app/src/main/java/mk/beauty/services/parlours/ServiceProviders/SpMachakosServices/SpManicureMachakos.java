...
import mk.beauty.services.parlours.ServiceProviders.SpMachakosServices.ClickPost.SpClickPostManicureMachakos;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.Posts;

public class SpManicureMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_manicure_machakos);
        ...
        postserviceslist = findViewById(R.id.recycler_sp_manicure_machakos);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpManicureMachakos.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpManicureMachakos.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, SpManicureMachakos.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpManicureMachakos.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpManicureMachakos.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        Intent clickPostIntent=new Intent(SpManicureMachakos.this, SpClickPostManicureMachakos.class);
...
//                });
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpManicureMachakos.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpManicureMachakos.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.sp_all_post_layout,parent,false);

                return new SpManicureMachakos.PostsViewholder(view);
            }
