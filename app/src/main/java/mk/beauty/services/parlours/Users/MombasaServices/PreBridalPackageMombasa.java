...
import mk.beauty.services.parlours.Users.MombasaServices.ClickPost.ClickPostPreBridalPackageMombasa;
import mk.beauty.services.parlours.Users.Posts;

public class PreBridalPackageMombasa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_bridal_package_mombasa);
        ...
        postserviceslist = findViewById(R.id.recycler_pre_bridal_packages_mombasa);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(PreBridalPackageMombasa.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(PreBridalPackageMombasa.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts,PreBridalPackageMombasa.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, PreBridalPackageMombasa.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull PreBridalPackageMombasa.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(PreBridalPackageMombasa.this, ClickPostPreBridalPackageMombasa.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(PreBridalPackageMombasa.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public PreBridalPackageMombasa.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new PreBridalPackageMombasa.PostsViewholder(view);
            }
