package mk.beauty.services.parlours.ServiceProviders.SpMachakosServices.ClickPost;
...
public class SpClickPostPreBridalPackageMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_pre_bridal_package_machakos);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("Services").child("Machakos").child("PreBridalPackage").child(PostKey);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostPreBridalPackageMachakos.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostPreBridalPackageMachakos.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostPreBridalPackageMachakos.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostPreBridalPackageMachakos.this, SpHomeLocation.class);
