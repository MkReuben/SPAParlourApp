...
public class SpClickPostPedicureMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_pedicure_meru);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostPedicureMeru.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostPedicureMeru.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostPedicureMeru.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostPedicureMeru.this, SpHomeLocation.class);
