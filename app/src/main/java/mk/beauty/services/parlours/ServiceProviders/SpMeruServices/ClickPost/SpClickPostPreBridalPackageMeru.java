package mk.beauty.services.parlours.ServiceProviders.SpMeruServices.ClickPost;
...
public class SpClickPostPreBridalPackageMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_pre_bridal_package_meru);

        mAuth=FirebaseAuth.getInstance();
        currentUserID=mAuth.getCurrentUser().getUid();

        PostKey =getIntent().getExtras().get("PostKey").toString();
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("Services").child("Meru").child("PreBridalpackage").child(PostKey);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostPreBridalPackageMeru.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostPreBridalPackageMeru.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostPreBridalPackageMeru.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostPreBridalPackageMeru.this, SpHomeLocation.class);
