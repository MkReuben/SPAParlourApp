...
public class FacialMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facial_machakos);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Machakos").child("Facial");
        ...
        postserviceslist = findViewById(R.id.recycler_facial_machakos);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(FacialMachakos.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(FacialMachakos.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, FacialMachakos.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, FacialMachakos.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull FacialMachakos.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(FacialMachakos.this, ClickPostFacialMachakos.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(FacialMachakos.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public FacialMachakos.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new FacialMachakos.PostsViewholder(view);
            }
