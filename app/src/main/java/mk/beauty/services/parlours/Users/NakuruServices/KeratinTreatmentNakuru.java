...
import mk.beauty.services.parlours.Users.NakuruServices.ClickPost.ClickPostKeratinTreatmentNakuru;
import mk.beauty.services.parlours.Users.Posts;

public class KeratinTreatmentNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keratin_treatment_nakuru);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nakuru").child("KeratinTreatment");
        ...
        postserviceslist = findViewById(R.id.recycler_keratin_treatment_nakuru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(KeratinTreatmentNakuru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(KeratinTreatmentNakuru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, KeratinTreatmentNakuru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, KeratinTreatmentNakuru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull KeratinTreatmentNakuru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(KeratinTreatmentNakuru.this, ClickPostKeratinTreatmentNakuru.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(KeratinTreatmentNakuru.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public KeratinTreatmentNakuru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new KeratinTreatmentNakuru.PostsViewholder(view);
            }
