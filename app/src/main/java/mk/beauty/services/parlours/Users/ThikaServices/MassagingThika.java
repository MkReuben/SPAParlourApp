...
import mk.beauty.services.parlours.Users.ThikaServices.ClickPost.ClickPostMassagingThika;

public class MassagingThika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_massaging_thika);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Thika").child("Massaging");
        ...
        postserviceslist = findViewById(R.id.recycler_massaging_thika);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(MassagingThika.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(MassagingThika.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, MassagingThika.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, MassagingThika.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull MassagingThika.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(MassagingThika.this, ClickPostMassagingThika.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(MassagingThika.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public MassagingThika.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new MassagingThika.PostsViewholder(view);
            }
