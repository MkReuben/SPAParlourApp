...
public class SpClickPostPedicureEldoret extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_pedicure_eldoret);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostPedicureEldoret.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostPedicureEldoret.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostPedicureEldoret.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void sendtoHomeActivity()
    {
        ...
        Intent intent=new Intent(SpClickPostPedicureEldoret.this, SpHomeLocation.class);
