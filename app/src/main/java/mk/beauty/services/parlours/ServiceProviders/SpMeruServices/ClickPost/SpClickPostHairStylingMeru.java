...
public class SpClickPostHairStylingMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_hair_styling_meru);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostHairStylingMeru.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostHairStylingMeru.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostHairStylingMeru.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostHairStylingMeru.this, SpHomeLocation.class);
