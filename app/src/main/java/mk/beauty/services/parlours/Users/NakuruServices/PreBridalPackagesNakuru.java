package mk.beauty.services.parlours.Users.NakuruServices;
...
import mk.beauty.services.parlours.Users.NakuruServices.ClickPost.ClickPostPrebridalPackagesNakuru;
import mk.beauty.services.parlours.Users.Posts;

public class PreBridalPackagesNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_bridal_packages_nakuru);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nakuru").child("PreBridalPackages");
        ...
        postserviceslist = findViewById(R.id.recycler_pre_bridal_packages_nakuru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(PreBridalPackagesNakuru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(PreBridalPackagesNakuru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, PreBridalPackagesNakuru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, PreBridalPackagesNakuru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull PreBridalPackagesNakuru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(PreBridalPackagesNakuru.this, ClickPostPrebridalPackagesNakuru.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(PreBridalPackagesNakuru.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public PreBridalPackagesNakuru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new PreBridalPackagesNakuru.PostsViewholder(view);
            }
