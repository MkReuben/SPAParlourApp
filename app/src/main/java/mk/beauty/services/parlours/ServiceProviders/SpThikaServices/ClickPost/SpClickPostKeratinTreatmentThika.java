...
public class SpClickPostKeratinTreatmentThika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_keratin_treatment_thika);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostKeratinTreatmentThika.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostKeratinTreatmentThika.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostKeratinTreatmentThika.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostKeratinTreatmentThika.this, SpHomeLocation.class);
