...
import mk.beauty.services.parlours.Users.MeruServices.ClickPost.ClickPostGelNailsMeru;
import mk.beauty.services.parlours.Users.Posts;

public class GelNailsMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gel_nails_meru);
        ...
        postserviceslist = findViewById(R.id.recycler_gel_nails_meru);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(GelNailsMeru.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(GelNailsMeru.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, GelNailsMeru.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, GelNailsMeru.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull GelNailsMeru.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(GelNailsMeru.this, ClickPostGelNailsMeru.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(GelNailsMeru.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public GelNailsMeru.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new GelNailsMeru.PostsViewholder(view);
            }
