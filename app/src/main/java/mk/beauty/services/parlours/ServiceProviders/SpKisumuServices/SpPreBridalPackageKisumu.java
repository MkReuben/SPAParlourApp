package mk.beauty.services.parlours.ServiceProviders.SpKisumuServices;
...
import mk.beauty.services.parlours.ServiceProviders.SpKisumuServices.ClickPost.SpClickPostPreBridalPackageKisumu;
import mk.beauty.services.parlours.ServiceProviders.SpNairobiServices.ClickPost.SpClickPostBraidingNairobi;
...
public class SpPreBridalPackageKisumu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_pre_bridal_package_kisumu);

        mAuth = FirebaseAuth.getInstance();
        currentUserID = mAuth.getCurrentUser().getUid();
        LikesRef = FirebaseDatabase.getInstance().getReference().child("Likes");
        CommentsRef=FirebaseDatabase.getInstance().getReference().child("Comments");
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Kisumu").child("PrebridalPackage");
        ...
        postserviceslist = findViewById(R.id.recycler_sp_prebridal_packages_kisumu);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpPreBridalPackageKisumu.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpPreBridalPackageKisumu.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, SpPreBridalPackageKisumu.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpPreBridalPackageKisumu.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpPreBridalPackageKisumu.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        Intent clickPostIntent=new Intent(SpPreBridalPackageKisumu.this, SpClickPostPreBridalPackageKisumu.class);
...
//                });
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpPreBridalPackageKisumu.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpPreBridalPackageKisumu.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.sp_all_post_layout,parent,false);

                return new SpPreBridalPackageKisumu.PostsViewholder(view);
            }
