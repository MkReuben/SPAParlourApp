...
import mk.beauty.services.parlours.ServiceProviders.SpMombasaServices.ClickPost.SpClickPostKeratinTreatmentMombasa;
...
public class SpKeratinTreatmentMombasa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_keratin_treatment_mombasa);
        ...
        postserviceslist = findViewById(R.id.recycler_sp_keratin_treatment_mombasa);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(SpKeratinTreatmentMombasa.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(SpKeratinTreatmentMombasa.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, SpKeratinTreatmentMombasa.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, SpKeratinTreatmentMombasa.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull SpKeratinTreatmentMombasa.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        Intent clickPostIntent=new Intent(SpKeratinTreatmentMombasa.this, SpClickPostKeratinTreatmentMombasa.class);
...
//                });
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(SpKeratinTreatmentMombasa.this, SpCommentActivity.class);
            ...
            @NonNull
            @Override
            public SpKeratinTreatmentMombasa.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.sp_all_post_layout,parent,false);

                return new SpKeratinTreatmentMombasa.PostsViewholder(view);
            }
