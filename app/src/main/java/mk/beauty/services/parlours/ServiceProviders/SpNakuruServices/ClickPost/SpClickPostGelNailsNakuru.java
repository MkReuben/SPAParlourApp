...
public class SpClickPostGelNailsNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_gel_nails_nakuru);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostGelNailsNakuru.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostGelNailsNakuru.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostGelNailsNakuru.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostGelNailsNakuru.this, SpHomeLocation.class);
