...
public class SpClickPostKeratinTreatmentMeru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_keratin_treatment_meru);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostKeratinTreatmentMeru.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostKeratinTreatmentMeru.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostKeratinTreatmentMeru.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostKeratinTreatmentMeru.this, SpHomeLocation.class);
