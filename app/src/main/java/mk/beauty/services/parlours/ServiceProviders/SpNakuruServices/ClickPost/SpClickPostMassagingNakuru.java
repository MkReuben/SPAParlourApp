...
public class SpClickPostMassagingNakuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_massaging_nakuru);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostMassagingNakuru.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostMassagingNakuru.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostMassagingNakuru.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostMassagingNakuru.this, SpMainActivity.class);
