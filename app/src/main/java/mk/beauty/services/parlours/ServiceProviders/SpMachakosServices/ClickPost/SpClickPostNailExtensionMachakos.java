...
public class SpClickPostNailExtensionMachakos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_nail_extension_machakos);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostNailExtensionMachakos.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostNailExtensionMachakos.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostNailExtensionMachakos.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostNailExtensionMachakos.this, SpHomeLocation.class);
