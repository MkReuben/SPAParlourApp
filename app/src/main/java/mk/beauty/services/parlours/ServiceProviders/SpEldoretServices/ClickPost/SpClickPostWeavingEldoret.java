...
public class SpClickPostWeavingEldoret extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sp_click_post_weaving_eldoret);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(SpClickPostWeavingEldoret.this);
        builder.setTitle("Edit Post");

        final EditText inputserviceName =new EditText(SpClickPostWeavingEldoret.this);
...
//                ClickPostRef.child("phonenumber").setValue(inputservicePhoneNumber.getText().toString());
                ...
                Toast.makeText(SpClickPostWeavingEldoret.this, "Your Service Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        Intent intent=new Intent(SpClickPostWeavingEldoret.this, SpHomeLocation.class);
