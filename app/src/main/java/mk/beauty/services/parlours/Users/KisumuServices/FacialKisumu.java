...
import mk.beauty.services.parlours.Users.KisumuServices.ClickPost.ClickPostFacialKisumu;
import mk.beauty.services.parlours.Users.LocationActivity;
import mk.beauty.services.parlours.Users.NakuruServices.ClickPost.ClickPostFacialNakuru;
import mk.beauty.services.parlours.Users.Posts;

public class FacialKisumu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facial_kisumu);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Kisumu").child("Facial");
        ...
        postserviceslist = findViewById(R.id.recycler_facial_kisumu);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(FacialKisumu.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(FacialKisumu.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, FacialKisumu.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, FacialKisumu.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull FacialKisumu.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(FacialKisumu.this, ClickPostFacialKisumu.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(FacialKisumu.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public FacialKisumu.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new FacialKisumu.PostsViewholder(view);
            }
