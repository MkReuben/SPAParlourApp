package mk.beauty.services.parlours.Users.NairobiServices;
...
import mk.beauty.services.parlours.Users.NairobiServices.ClickPost.ClickPostBraiding;
import mk.beauty.services.parlours.Users.NairobiServices.ClickPost.ClickPostPreBridalPackages;
import mk.beauty.services.parlours.Users.Posts;

public class PreBridalPackages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_bridal_packages);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Nairobi").child("PreBridalPackages");
        ...
        postserviceslist = findViewById(R.id.recycler_pre_bridal_packages);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(PreBridalPackages.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(PreBridalPackages.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, PreBridalPackages.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, PreBridalPackages.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull PreBridalPackages.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(PreBridalPackages.this, ClickPostPreBridalPackages.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(PreBridalPackages.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public PreBridalPackages.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new PreBridalPackages.PostsViewholder(view);
            }
