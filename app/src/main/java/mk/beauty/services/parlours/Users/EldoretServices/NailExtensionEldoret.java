...
import mk.beauty.services.parlours.Users.EldoretServices.ClickPost.ClickPostNailExtensionEldoret;
...
public class NailExtensionEldoret extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nail_extension_eldoret);
        ...
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Eldoret").child("NailExtension");
        ...
        postserviceslist = findViewById(R.id.recycler_nail_extensions_eldoret);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(NailExtensionEldoret.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(NailExtensionEldoret.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts, NailExtensionEldoret.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, NailExtensionEldoret.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull NailExtensionEldoret.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(NailExtensionEldoret.this, ClickPostNailExtensionEldoret.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(NailExtensionEldoret.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public NailExtensionEldoret.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new NailExtensionEldoret.PostsViewholder(view);
            }
