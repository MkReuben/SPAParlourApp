...
import mk.beauty.services.parlours.Users.MeruServices.ClickPost.ClickPostNailExtensionMeru;
import mk.beauty.services.parlours.Users.MeruServices.NailExtensionMeru;
import mk.beauty.services.parlours.Users.MombasaServices.ClickPost.ClickPostFacialMombasa;
import mk.beauty.services.parlours.Users.NairobiServices.ClickPost.ClickPostFacial;
import mk.beauty.services.parlours.Users.Posts;

public class facialMombasa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facial_mombasa);

        mAuth = FirebaseAuth.getInstance();
        currentUserID = mAuth.getCurrentUser().getUid();
        LikesRef = FirebaseDatabase.getInstance().getReference().child("Likes");
        CommentsRef=FirebaseDatabase.getInstance().getReference().child("Comments");
        PostsRef = FirebaseDatabase.getInstance().getReference().child("Services").child("Mombasa").child("Facial");
        ...
        postserviceslist = findViewById(R.id.recycler_facial_mombasa);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        // do something
                        Toast.makeText(facialMombasa.this, "Refreshed successfully", Toast.LENGTH_LONG).show();
        ...
        img_locations.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent =new Intent(facialMombasa.this, LocationActivity.class);
    ...
    private void DisplayAllUsersPost()
    {
        ...
        FirebaseRecyclerAdapter<Posts,facialMombasa.PostsViewholder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Posts, facialMombasa.PostsViewholder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull facialMombasa.PostsViewholder holder, int position, @NonNull Posts model) {
...
//                holder.servicelocation.setText(model.getLocation());
                ...
                holder.bookus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent clickPostIntent=new Intent(facialMombasa.this, ClickPostFacialMombasa.class);
                ...
                holder.commentPostButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent intent=new Intent(facialMombasa.this, CommentsActivity.class);
            ...
            @NonNull
            @Override
            public facialMombasa.PostsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                LayoutInflater inflater=LayoutInflater.from(parent.getContext());
                View view=inflater.inflate(R.layout.all_service_post_layout,parent,false);

                return new facialMombasa.PostsViewholder(view);
            }
